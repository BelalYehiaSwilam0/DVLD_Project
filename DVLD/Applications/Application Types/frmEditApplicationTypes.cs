...
namespace DVLD
{
    public partial class frmEditApplicationTypes : Form
    {
        ...
        public frmEditApplicationTypes(int applicatinTypeID)
        {
            InitializeComponent();
            this._ApplicationTypeID = applicatinTypeID;
        }
       
        private void frmEditApplicationTypes_Load(object sender, EventArgs e)
        {
            lblID.Text = _ApplicationTypeID.ToString();
            _ApplicationType = clsApplicationTypes.GetApplicationTypeInfoByID(_ApplicationTypeID);
